...
export function seedToPalette(
  ...
  const palette: SemanticPalette = {
    ...
    secondaryContainer: argbToOklch(scheme.secondaryContainer),
    onSecondaryContainer: argbToOklch(scheme.onSecondaryContainer),
    tertiary: argbToOklch(scheme.tertiary),
    onTertiary: argbToOklch(scheme.onTertiary),
