...
namespace Amuse.Modules.Billing.Persistence.Migrations
{
    ...
    [Migration("20260607223942_SyncBillingCollaboratorModel")]
    partial class SyncBillingCollaboratorModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "billing", "refund_initiator_role", new[] { "platform", "seller" });
            ...
            modelBuilder.Entity("Amuse.Domain.Billing.CreditNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<RefundFeeBearer>("RefundFeeBearer")
                        .HasColumnType("billing.refund_fee_bearer")
                        .HasColumnName("refund_fee_bearer");

                    b.Property<long>("RefundFeeMinor")
                        .HasColumnType("bigint")
                        .HasColumnName("refund_fee_minor");
            ...
            modelBuilder.Entity("Amuse.Domain.Billing.PaymentTransaction", b =>
                {
                    ...
                    b.Property<long?>("PspFeeMinor")
                        .HasColumnType("bigint")
                        .HasColumnName("psp_fee_minor");
            ...
            modelBuilder.Entity("Amuse.Domain.Billing.PayoutProfile", b =>
                {
                    ...
                    b.Property<string>("BankAccountProtected")
                        .HasColumnType("text")
                        .HasColumnName("bank_account_protected");
                    ...
                    b.Property<string>("TaxIdProtected")
                        .HasColumnType("text")
                        .HasColumnName("tax_id_protected");
                    ...
                    b.PrimitiveCollection<string>("_documentObjectKeys")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("Amuse.Domain.Billing.Purchase", b =>
                {
                    ...
                    b.Property<Guid?>("RefundInitiatedByAccountId")
                        .HasColumnType("uuid")
                        .HasColumnName("refund_initiated_by_account_id");

                    b.Property<RefundInitiatorRole?>("RefundInitiatorRole")
            ...
            modelBuilder.Entity("Amuse.Domain.Billing.WithdrawalRequest", b =>
                {
                    ...
                    b.Property<string>("ProofObjectKey")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("proof_object_key");
            ...
            modelBuilder.Entity("Amuse.Domain.Catalog.TrackCollaborator", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("track_collaborator", "billing");
                });
