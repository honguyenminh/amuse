...
When working with pinned SHAs in CI/CD and/or packages versions, do NOT use SHAs or code from training set or taken from hallucinations, always get that SHA/tags from official sources, and ensure they exists.
